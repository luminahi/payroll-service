...
public class OrderController {
    ...
    @PostMapping("/orders")
    ResponseEntity<?> newOrder(@RequestBody Order order) throws OrderNotFoundException {
    ...
    ResponseEntity<?> cancel(@PathVariable Long id) throws OrderNotFoundException {
        ...
        if (order.getStatus() == Status.IN_PROGRESS) {
            ...
            return ResponseEntity
                .ok(assembler.toModel(repository.save(order)));
        }
    ...
    ResponseEntity<?> complete(@PathVariable Long id) throws OrderNotFoundException {
